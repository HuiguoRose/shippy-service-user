...
run:
	#docker run --net="host" --rm=true -e MICRO_REGISTRY=mdns -e MICRO_ADDRESS=":50051" -e DB_NAME=postgres -e DB_HOST=localhost -e DB_PORT=5432 -e DB_USER=postgres -e DB_PASSWORD=postgres -p 50053:50051 shippy-service-user
